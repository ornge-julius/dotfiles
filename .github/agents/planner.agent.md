...
ALWAYS refer to the technical-product-owner skill for guidance on how to create implementation plans. This skill contains the mandatory planning principles that you must follow. These principles are designed to ensure that your plans are comprehensive, actionable, and aligned with user needs.
